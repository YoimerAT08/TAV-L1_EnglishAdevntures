<template>
    <div class="titulo">
        <div class="titulo-container">
            <h1 class="titulo-pattern">Aprendiendo Listening</h1>
        </div>
    </div>
    <div class="container">
            <h2 class="bienvenido">
    ...
    <div class="progreso">
           <div class="imagen"><div class="video"><iframe width="400" height="250" src="https://www.youtube-nocookie.com/embed/7pMEQsk3c5Y?controls=0" ></iframe></div></div>
           <div class="letra">
            <p>
<b>Let's Sing Together</b> <br>
Down in the deep blue sea.
Come and take a dive with me. <br>

//We’ll see a swimming _____//
Come and take a dive with me. <br>

//We’ll see an _____//
Come and take a dive with me. <br>

//We’ll see a great big _____//
Come and take a dive with me. <br>

//We’ll see a baby _____//
Come and take a dive with me. <br>
